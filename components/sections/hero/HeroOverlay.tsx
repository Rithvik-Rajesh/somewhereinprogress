  ...
  return (
    <>
      <div className={cn(heroLayers.overlay)} aria-hidden>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[rgb(0_0_0/0.25)] via-transparent to-[rgb(0_0_0/0.3)]" />
        
        {/* Soft radial to preserve the center city lights */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgb(0_0_0/0.15)_100%)]" />
        
        {/* Left side soft gradient to provide a bit of backing for left-aligned typography */}
        <div className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-[rgb(0_0_0/0.3)] via-[rgb(0_0_0/0.1)] to-transparent" />
      </div>
