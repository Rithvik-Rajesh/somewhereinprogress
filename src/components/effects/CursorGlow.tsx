...
export default function CursorGlow({ x, y, isInside }: CursorGlowProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="absolute left-1/2 top-1/2 h-[18rem] w-[18rem] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-85 blur-3xl"
        animate={
          shouldReduceMotion
            ? undefined
            : {
                scale: [0.92, 1.08, 0.96, 1.12, 0.92],
                opacity: [0.58, 0.86, 0.66, 0.94, 0.58],
              }
        }
          ...
          animate={
            shouldReduceMotion
              ...
              : {
                  ...
                  borderTopLeftRadius: ["85%", "48%", "88%", "54%", "82%", "85%"],
                  borderTopRightRadius: ["22%", "76%", "28%", "68%", "34%", "22%"],
